...
namespace ImageSharingWithCloudService.Service_Bus
{
    public class QueueConnector
    {
        ...
        public const string Namespace = "imagesharing526bus";
        public const string SharedAccessKeyName = "RootManageSharedAccessKey";
        public const string SharedAccessKey = "1HgIs5UiWWdBQT9oBFTnCJX5vNjmmTxbS8j8GdOGiNI=";

        // The name of your queue
        public const string QueueName = "vqueue";
