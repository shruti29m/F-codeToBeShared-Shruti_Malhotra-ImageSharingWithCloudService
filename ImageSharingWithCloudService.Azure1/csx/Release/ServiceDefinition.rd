...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="ImageSharingWithCloudService.Azure1" generation="1" functional="0" release="0" Id="60089630-6a28-4856-a212-efaf1874f676" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="ImageSharingWithCloudService.Azure1Group" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="ImageSharingWebRole" generation="1" functional="0" release="0" software="C:\Users\smalhot1\Documents\Visual Studio 2015\Projects\Deploy\ImageSharingWithCloudService\ImageSharingWithCloudService.Azure1\csx\Release\roles\ImageSharingWebRole" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
        ...
        <groupHascomponents>
          <role name="ImageSharingWorkerRole" generation="1" functional="0" release="0" software="C:\Users\smalhot1\Documents\Visual Studio 2015\Projects\Deploy\ImageSharingWithCloudService\ImageSharingWithCloudService.Azure1\csx\Release\roles\ImageSharingWorkerRole" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <settings>
  ...
  <implements>
    <implementation Id="19651c11-34b1-4129-8452-5f2ac1e1f03b" ref="Microsoft.RedDog.Contract\ServiceContract\ImageSharingWithCloudService.Azure1Contract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="a8fcb525-9db5-425a-9489-ea1e83038a11" ref="Microsoft.RedDog.Contract\Interface\ImageSharingWebRole:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/ImageSharingWithCloudService.Azure1/ImageSharingWithCloudService.Azure1Group/ImageSharingWebRole:Endpoint1" />
          </inPort>
        </interfaceReference>
